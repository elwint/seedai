...
def parse_args():
	...
	parser.add_argument("--execs", "-E", type=int, default=-1,
					 help=f"number of model executions. Default is equal to number of seeds. Useful for prompt tuning.")
	...
	if generate_args['num_beams'] == '<execs>':
		generate_args['num_beams'] = args.execs
